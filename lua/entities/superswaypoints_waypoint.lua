...
function ENT:SetupDataTables()
	...
	self:NetworkVar("Bool",3,"IsWaypointActive", {KeyName = "is_waypoint_active", Edit = {type = "Boolean", order = 3}})
	self:NetworkVar("Bool",4,"ShouldDrawBlur", {KeyName = "ShouldDrawBlur", Edit = {type = "Boolean", order = 4}})
	self:NetworkVar("Bool",5,"ObjectiveBeforeName", {KeyName = "ObjectiveBeforeName", Edit = {type = "Boolean", order = 5}})
	if SERVER then
